...
#
#Lance en arriere plan la lecture du fichier multimédia pour permttre a exec.php de finr de s'executer


python ` grep shell config.inc.php |cut -d \" -f 2`playm.py "$1" >/dev/null &
